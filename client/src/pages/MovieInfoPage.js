        ...
        <div style={{ display: "flex", alignItems: "start" }}>
          <div style={{ marginRight: "20px" }}>
            ...
            {movieData.release_date && (
              <p>Release Date: {formatReleaseDate(movieData.release_date)}</p>
            )}
            ...
            {movieData.production_companies && (
              <p>Production Companies: {movieData.production_companies}</p>
            )}
            {movieData.production_countries && (
              <p>Production Countries: {movieData.production_countries}</p>
            )}
            {movieData.spoken_languages && (
              <p>Spoken Languages: {movieData.spoken_languages}</p>
            )}
          </div>
          <div>
